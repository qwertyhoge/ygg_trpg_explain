...
function Battle(props){
    ...
    return <PageBase header={props.header}>
        ...
        <ProgressCard title="バーストについて" links={burstLinks}>
            <ProgressParagraph>
                AEと同様の理由でここで紹介しておく。やはり戦闘以外でも使えるものもあるが、ものによって使用可能タイミングがかなり異なる。戦闘上のフェイズについて概要を把握した後、再確認するとよい。
            </ProgressParagraph>
            <ProgressParagraph>
                いずれも因子ダイスを対価として特異な効果や回復を得るもの。どれくらいの因子ダイスを消費するかはバーストの種類による。
            </ProgressParagraph>
            <ProgressParagraph>
        ...
        <ProgressCard title="イニシアティブフェイズ">
            <ProgressParagraph>
                行動順を決めるフェイズ。AE【コンセントレイション】による行動値の補正が可能なほか、トラップなど特定のSEが付いた能力の使用タイミングであったりする。
            </ProgressParagraph>
            <ProgressParagraph>
                ここでの宣言は予め決めておき、後出しはできないものとする。これはアクションフェイズのプリアクション・リアクションを真似たAE対抗にステータスやリソース面での問題を感じたため。
            </ProgressParagraph>
        </ProgressCard>
